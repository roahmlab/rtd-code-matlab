...
- utils: contains some utility classes that can also be subclassed for some quick useful functionality - rtd.core.mixins.NamedClass and rtd.core.mixins.UUID.
