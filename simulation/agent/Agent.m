classdef Agent < handle & NamedClass & UUIDbase
% Generic Agent
    properties
        
        % Store state, time, input, input_time
        
        % geometry (visual, collision), dynamics, controller
    end
    ...
    methods
        ...
        function reset(self, state)
            % Set the agent to it's base state as defined by the geometry
        end
    ...
    properties
        ...
        animation_time_discretization  = 0.2 ;
