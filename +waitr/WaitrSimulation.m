classdef WaitrSimulation < rtd.sim.BaseSimulation & handle
    properties
    ...
    methods
        ...
        function self = WaitrSimulation(optionsStruct, options)
            arguments
...
%             end
            ...
            % Edit for predefined obstacles
%             center_all = [-0.0584,  0.1813, 0.4391;
%                            0.5333, -0.2291, 0.2884;
%                            0.2826,  0.5121, 0.2953]; 
%             side_lengths_all = [0.3915, 0.0572, 0.1350;
%                                 0.1760, 0.3089, 0.1013;
%                                 0.1545, 0.2983, 0.0352];
%             for obs_num = 1:n_obstacles
%                 % create center, side lengths
%                 center = center_all(:,obs_num);
%                 side_lengths = side_lengths_all(obs_num,:);
%                 % Create obstacle
...
%             end
            ...
            self.goal_system = armour.deprecation.RandomArmConfigurationGoal(self.collision_system, self.agent, goal_radius=pi/90);
