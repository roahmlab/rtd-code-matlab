...
% and glueing this together
    ...
    methods (Static)
        function options = defaultoptions()
            ...
            components.info = 'armour.agent.ArmourAgentInfo';
            components.state = 'armour.agent.ArmourAgentState';
            components.kinematics = 'armour.agent.ArmKinematics';
            components.controller = 'armour.agent.ArmourController';
            components.dynamics = 'armour.agent.ArmourDynamics';
            components.collision = 'armour.agent.ArmourPatchCollision';
            components.visual = 'armour.agent.ArmourPatchVisual';
