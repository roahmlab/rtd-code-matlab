classdef Patch3dCollisionSystem < rtd.sim.systems.SimulationSystem & rtd.util.mixins.NamedClass & rtd.util.mixins.Options & handle
    ...
    properties
        static_objects (1,:) rtd.sim.systems.patch3d_collision.Patch3dObject = rtd.sim.systems.patch3d_collision.Patch3dObject.empty()
        dynamic_objects (1,:) rtd.sim.systems.patch3d_collision.Patch3dDynamicObject = rtd.sim.systems.patch3d_collision.Patch3dDynamicObject.empty()
    end
    ...
    methods
        function self = Patch3dCollisionSystem(objects, optionsStruct, options)
            arguments
                objects.static_objects (1,:) rtd.sim.systems.patch3d_collision.Patch3dObject = rtd.sim.systems.patch3d_collision.Patch3dObject.empty()
                objects.dynamic_objects (1,:) rtd.sim.systems.patch3d_collision.Patch3dDynamicObject = rtd.sim.systems.patch3d_collision.Patch3dDynamicObject.empty()
        ...
        function reset(self, optionsStruct, options)
            ...
            self.static_objects = rtd.sim.systems.patch3d_collision.Patch3dObject.empty();
            self.dynamic_objects = rtd.sim.systems.patch3d_collision.Patch3dDynamicObject.empty();
        end
        
        function addObjects(self, objects)
            arguments
                self rtd.sim.systems.patch3d_collision.Patch3dCollisionSystem
                objects.static (1,:) rtd.sim.systems.patch3d_collision.Patch3dObject = rtd.sim.systems.patch3d_collision.Patch3dObject.empty()
                objects.dynamic (1,:) rtd.sim.systems.patch3d_collision.Patch3dDynamicObject = rtd.sim.systems.patch3d_collision.Patch3dDynamicObject.empty()
            end
