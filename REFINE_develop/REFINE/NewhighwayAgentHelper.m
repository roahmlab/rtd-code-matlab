...
%         t_move
    ...
    %% methods
    methods
        function AH = NewhighwayAgentHelper(A, frs , HLP,worldState, trajOptProps,varargin)
        ...
        function [K,tout] = gen_parameter_standalone(AH, worldinfo,agent_state,waypoints)
            ...
            [traj,info] = AH.refinePlanner.planTrajectory(agent_state(1:6),worldinfo,waypoints);%initially it was AH.robotstate,worldinfo,AH.worldState
            K = traj;
            tout = info;
