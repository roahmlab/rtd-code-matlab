...
for j = 1:50
    ...
    frs = planner.Refine_Planner(trajOptProps,Agent);
    AgentHelper = NewhighwayAgentHelper(Agent,frs.rs_speed.frs_,HLP,worldState,trajOptProps); % takes care of online planning
